 ...
 *
 * @method static \App\Services\HttpChecker setClient(\GuzzleHttp\Client $client) Set the HTTP client instance.
 * @method static \App\Services\HttpChecker setMaxRedirects(int $maxRedirects) Set the maximum number of redirects to follow.
