 ...
 *
 * @method static \Scannr\Services\UrlNormalizer setBaseUrl(string $baseUrl) Set the base URL for scanning.
 * @method static string getBaseUrl() Get the current base URL.
 * @method static string getBaseHost() Get the current base host.
 * @method static \Scannr\Services\UrlNormalizer setTrackingParams(array $params) Set the tracking parameters to strip from URLs.
 * @method static \Scannr\Services\UrlNormalizer addTrackingParams(array $params) Add additional tracking parameters to strip from URLs.
 ...
 *
 * @see \Scannr\Services\UrlNormalizer
 */
