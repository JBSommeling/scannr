...
class ResultFormatterService
{
    ...
    public function format(array $results, ScanConfig $config, OutputInterface $output, ?string $error = null): IntegrityScoreResult
    {
        ...
        if (! $config->showAdvanced) {
            $results = $this->scanStatistics->filterNoiseUrls($results, config('scannr.noise_urls', []));
        }
     ...
     */
    protected function displayTable(array $results, \Scannr\DTO\IntegrityScoreResult $scoreResult, array $stats, int $totalScanned, bool $isFiltered, OutputInterface $output, ?string $error = null): void
    {
     ...
     */
    protected function displayIntegrityScore(\Scannr\DTO\IntegrityScoreResult $score, OutputInterface $output): void
    {
     ...
     */
    protected function displayJson(array $results, \Scannr\DTO\IntegrityScoreResult $scoreResult, array $stats, int $totalScanned, bool $isFiltered, OutputInterface $output, ?string $error = null): void
    {
     ...
     */
    protected function displayCsv(array $results, \Scannr\DTO\IntegrityScoreResult $scoreResult, array $stats, int $totalScanned, bool $isFiltered, OutputInterface $output, ?string $error = null): void
    {
